...
export default function LoginPage() {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (data.message && (data.message.includes("incorrect") || data.message.includes("Incorrect"))) {
                ...
                <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        ...
                        >
                            ...
                            <p className="text-white/60 text-sm mt-1">Enter your details to access your account</p>
                        </motion.div>
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className="bg-white/5 border-white/10 text-white placeholder:text-white/20 focus-visible:ring-orange-500/50 focus-visible:border-orange-500 transition-all pl-10 py-6 mt-3"
                                />
                        ...
                        >
                            ...
                            <Input
                                ...
                                className="bg-white/5 border-white/10 text-white placeholder:text-white/20 focus-visible:ring-orange-500/50 focus-visible:border-orange-500 transition-all py-6 mt-3"
                            />
                        </motion.div>
                        ...
                        >
                            ...
                            <Link href="/signup" className="text-orange-400 hover:text-orange-300 font-medium hover:underline underline-offset-4">
                                Sign up
                            </Link>
                        </motion.div>
                    </div>
