...
export default function SignupPage() {
    ...
    const handleSignup = async () => {
        ...
        try {
            const response = await fetch("http://127.0.0.1:8000/signup", {
                ...
                body: JSON.stringify({
                    username: `${formData.firstName} ${formData.lastName}`, // Using full name as username for now or just first name
    ...
    return (
        <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
                ...
                <div className="absolute inset-0">
                    ...
                    >
                        <defs>
                            ...
                            <filter id="heroTextBlur" y="-50%" width="200%" height="200%">
            ...
            >
                <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-white/5 rounded-2xl blur-xl -z-10" />
                <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden group">
                    ...
                    {/* Hover Glow Effect */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/5 via-transparent to-orange-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-lg -z-10" />
                    ...
                    <div className="flex items-center justify-between mb-8">
                        ...
                        >
                            ...
                            <p className="text-white/60 text-sm mt-1">Get started with RetentionAI today</p>
                        </motion.div>
                        <Link href="/" className="text-white/40 hover:text-white transition-colors p-2 hover:bg-white/10 rounded-full">
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className="bg-white/5 border-white/10 text-white placeholder:text-white/20 focus-visible:ring-orange-500/50 focus-visible:border-orange-500 transition-all pl-9 py-6"
                                    />
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="bg-white/5 border-white/10 text-white placeholder:text-white/20 focus-visible:ring-orange-500/50 focus-visible:border-orange-500 transition-all py-6"
                                />
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className="bg-white/5 border-white/10 text-white placeholder:text-white/20 focus-visible:ring-orange-500/50 focus-visible:border-orange-500 transition-all pl-10 py-6"
                                />
                        ...
                        >
                            {error && (
                                <div className="text-red-500 text-sm text-center bg-red-500/10 p-2 rounded mb-2">
                                    {error}
                                </div>
                            )}
                            <ShimmerButton
                                ...
                                disabled={isLoading}
                                className="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 rounded-xl shadow-lg shadow-orange-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                        ...
                        >
                            ...
                            <Link href="/login" className="text-orange-400 hover:text-orange-300 font-medium hover:underline underline-offset-4">
                                Sign in
                            </Link>
                        </motion.div>
                    </div>
